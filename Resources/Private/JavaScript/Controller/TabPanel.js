...
export default class TabPanel extends Showable {
	onShow(event) {
		...
		this.controlTargets.forEach(t => (t.ariaSelected = 'true'))
	}
	onHide(event) {
		super.onHide(event)
		this.element.style.maxHeight = '0'
		this.controlTargets.forEach(t => (t.ariaSelected = 'false'))
	}
	...
	disconnected() {
		...
		this.controlTargets.forEach(t => t.removeAttribute('role'))
	}
}
