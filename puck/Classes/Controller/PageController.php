...
class PageController extends ActionController
{
    ...
    protected function getFaviconHeadTags($siteSettings): string
    {
        ...
        return '<link rel="icon" type="image/x-icon" href="' . $faviconPath . '/favicon.ico">
        <link rel="icon" type="image/png" sizes="16x16" href="' . $faviconPath . '/favicon-16x16.png">
        <link rel="icon" type="image/png" sizes="32x32" href="' . $faviconPath . '/favicon-32x32.png">
        <link rel="icon" type="image/png" sizes="48x48" href="' . $faviconPath . '/favicon-48x48.png">
        ...
        <link rel="apple-touch-icon" sizes="167x167" href="' . $faviconPath . '/apple-touch-icon-167x167.png">
        <link rel="apple-touch-icon" sizes="180x180" href="' . $faviconPath . '/apple-touch-icon-180x180.png">
        <link rel="apple-touch-icon" sizes="1024x1024" href="' . $faviconPath . '/apple-touch-icon-1024x1024.png">';
    }
}
