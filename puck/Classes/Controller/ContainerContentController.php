 ...
 */
class ContainerContentController extends ActionController
{
    /**
    ...
    public function indexAction(): string
    {
        try {
            ...
            $targetObject = ClassNamingUtility::getFqnByPath($vendorName, $extensionKey, 'Domain/Model/Content/Container/' . $name);
