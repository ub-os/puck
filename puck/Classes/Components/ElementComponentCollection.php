...
final class ElementComponentCollection extends AbstractComponentCollection
{
	...
	public function getTemplatePaths(): TemplatePaths
	{
		...
		$templatePaths->setTemplateRootPaths([
			ExtensionManagementUtility::extPath('puck', 'Resources/Private/FluidComponents/Elements/')
		]);
