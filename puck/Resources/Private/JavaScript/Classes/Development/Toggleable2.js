...
class ToggleableOptions {
    ...
    addMatchingHashLinksToToggles = this.toggleOnIfUrlHashMatches
    pauseMediaOnToggle = true
    reloadIframeOnToggle = this.pauseMediaOnToggle
...
export default class Toggleable extends AbstractComponent {
  ...
  constructor(target, options = {}) {
    super(target, new ToggleableOptions(options))
    ...
    this.toggles = this.toggles || document.querySelectorAll(`[aria-controls="${this.id}"]`)
